...
export class KobongApiRestAdapter {
    async request(req) {
        const cli = resolve("scripts/acl/kobong-api.mjs");
        const args = [`--url=${req.url}`];
        if (req.method)
